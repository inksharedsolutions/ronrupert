            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            Ron Rupert loves to hear from readers. You can reach him via email.
                        ...
                        <nav className="social-media-nav">
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.facebook.com/Ron-Rupert-107503044148042/"
                                        target="_blank"
                                        rel="noreferrer">
                                        <FontAwesomeIcon
                                ...
                                <li>
                                    <a
                                        target="_blank"
                                        href="https://www.goodreads.com/book/show/50991552-true-crime-cases"
                                        rel="noreferrer"
                                    >
